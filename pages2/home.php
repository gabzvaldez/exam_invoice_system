...
<!-- ========================================================================================================= -->
      ...
      <div ng-if="search.division=='STO'"class="form-group col-sm-3">
          ...
          <select ng-model='search.cluster' ng-click="specific_program()" class="form-control" id="sel1">
 ...
 <option>PLANNING</option>
      ...
      <div ng-if="search.division=='RLED'"class="form-group col-sm-3">
          ...
          <select ng-model='search.cluster' ng-click="specific_program()"  class="form-control" id="sel1">
           ...
           <option>RD/ARD</option>
           <option>RLED-CAO/SAO</option>
           <option>RLED-ACCOUNTING</option>
           <option>RLED-SUPPLY</option>
           <option>RLED-RECORDS</option>
           <option>RLED-CASHIER</option>
           <option>RLED-LEGAL</option>
           <option>RLED-PLANNING</option>
  ...
  Annual Allocation:<p style="font-weight: bold">{{alloc | number : 2}}</p>
  Annual Balance:<p style="font-weight: bold">{{annual_balance | number : 2}}</p>
  Obligation Rate:<p style="font-weight: bold;">{{obligation_rate | number : 2}}%</p>
  Disbursement Rate:<p style="font-weight: bold;">{{dis_rate | number : 2}}%</p>
    ...
    color: white;">
        ...
        <tbody>
          <tr ng-repeat="item in all">
            ...
            <!-- <td>{{item.PROGRAMS}}</td> -->
            <td><button class="button" ng-click="specific_transaction(item.cid)" data-toggle='modal' data-target='#editModal'><i class="fa fa-search" style="font-size: 12px;"></i></button></td>
            <td>{{item.OBR_NUM}}</td>
            <td>{{item.CREDITOR}}</td>
            <!-- <td>{{item.CREDITOR}}</td> -->
